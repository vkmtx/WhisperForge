...
class RecordingStore: ObservableObject {
    ...
    func getPendingRecordings() -> [Recording] {
        do {
            ...
            Log.debug("Failed to get pending recordings: \(error)")
            return []
        }
    }
    ...
    func getNextPendingRecording() -> Recording? {
        do {
            ...
            Log.debug("Failed to get next pending recording: \(error)")
            return nil
        }
    }
    ...
    func addRecording(_ recording: Recording) {
        Task {
            do {
                ...
                Log.debug("Failed to add recording: \(error)")
            }
        }
    }
    ...
    func updateRecording(_ recording: Recording) {
        Task {
            do {
                ...
                Log.debug("Failed to update recording: \(error)")
            }
        }
    }
    ...
    func updateRecordingProgressOnlySync(_ id: UUID, transcription: String, progress: Float, status: RecordingStatus, isRegeneration: Bool? = nil) async {
        do {
            ...
            Log.debug("Failed to update recording progress: \(error)")
        }
    }
    ...
    func updateRecordingStatusOnly(_ id: UUID, progress: Float, status: RecordingStatus, isRegeneration: Bool? = nil) async {
        do {
            ...
            Log.debug("Failed to update recording status: \(error)")
        }
    }
    ...
    func deleteRecording(_ recording: Recording) {
        ...
        Task {
            do {
                ...
                Log.debug("Failed to delete recording: \(error)")
            }
        }
    }
    ...
    func deleteAllRecordings() {
        Task {
            do {
                ...
                Log.debug("Failed to delete all recordings: \(error)")
            }
        }
    }
    ...
    func searchRecordings(query: String) -> [Recording] {
        do {
            ...
            Log.debug("Failed to search recordings: \(error)")
            return []
        }
    }
