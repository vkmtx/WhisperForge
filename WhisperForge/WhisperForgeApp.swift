...
class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        WhisperForgeApp.startTranscriptionQueue()
    ...
    private func setupStatusBarItem() {
        ...
        if let button = statusItem?.button {
            if let iconImage = NSImage(named: "tray_icon") {
                ...
                button.image = NSImage(systemSymbolName: "waveform", accessibilityDescription: "WhisperForge")
            }
    ...
    private func updateStatusBarMenu() {
        ...
        menu.addItem(NSMenuItem(title: "WhisperForge", action: #selector(openApp), keyEquivalent: "o"))
